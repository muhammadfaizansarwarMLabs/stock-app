...
- What happens if an image file fails to fetch during ZIP preparation? → The download proceeds with successfully fetched images and the user is notified via an inline alert below the navbar.
