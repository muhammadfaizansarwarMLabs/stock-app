...
## Recent Changes
- 002-bulk-download-zip: Added JavaScript (ES2022) / React 18.3 + React Router v6.30, Tailwind CSS v3.4, Vite 5.4, JSZip 3.x (new addition)

- 001-modern-stock-gallery: Added JavaScript (ES2022+) with React.js + React.js, React Router (route-based pages + modal overlay pattern), Tailwind CSS
